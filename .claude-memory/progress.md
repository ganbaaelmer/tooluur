...
Сүүлд шинэчилсэн: **2026-07-26** · v1.2.0
...
### v1.2.0 — ГОЛ ЗОРИЛГОД нийцүүлсэн: хоёр төлбөрийн хэлбэр
...
**Тест:** `gjs`-ээр DOM stub хийж app.js-ийг ажиллуулсан **128/128 өнгөрсөн**
...
43 `data-act` бүрт handler байгаа, орхигдсон код үлдээгүйг cross-check хийсэн.
...
- **Хөтөч дээр нүдээрээ шалгаагүй** — Firefox нь snap учраас headless screenshot
  ажиллаагүй (`gotchas.md` G-004). Логик 128/128 тестээр батлагдсан ч layout-ыг
