...
Сүүлд шинэчилсэн: **2026-07-26** · v2.0.0
...
**Тест:** `gjs`-ээр DOM stub хийж app.js-ийг ажиллуулсан **147/147 өнгөрсөн**
...
45 `data-act` бүрт handler байгаа, орхигдсон код үлдээгүйг cross-check хийсэн.
...
- **Хөтөч дээр нүдээрээ шалгаагүй** — Firefox нь snap учраас headless screenshot
  ажиллаагүй (`gotchas.md` G-004). Логик 147/147 тестээр батлагдсан ч layout-ыг
